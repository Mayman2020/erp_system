...
export class CardComponent implements OnInit {
  ...
  collapsedCardToggle() {
    ...
    this.collapsedIcon = this.collapsedCard === 'collapsed' ? 'add' : 'remove';
  }
  ...
  get reloadLabel(): string {
    return this.translationService.instant('COMMON.RELOAD');
  }

  get removeLabel(): string {
    return this.translationService.instant('COMMON.REMOVE');
  }
